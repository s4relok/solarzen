...
LEVELS_TARGETS = [// 1
[new Target(G.X2, 100)], // 2 
 [new Target(G.X2 - 100, 100), new Target(G.X2 + 100, 100)], // 3
 [new Target(G.X2, 100), new CircleTarget(G.X2, 100, 72, 0.05)], // 4
 [new Target(G.X2 - 100, 100 + 70), new Target(G.X2 + 100, 100 - 70), new Target(G.X2, 100)], // 5
 [new CircleTarget(G.X2 + 50, 100, 60, -0.05), new CircleTarget(G.X2 - 50, 100, 60, 0.05)], // 6
 [new CircleTarget(G.X2 + 50, 80, 40, 0.05), new CircleTarget(G.X2 - 50, 80, 40, 0.05), ], // 7
 [new SlideXTarget(50, 40, 1), new SlideXTarget(90, 100, 2), new SlideXTarget(130, 160, 3), ], // 8
 [new CircleTarget(G.X2 + 50, 100, 60, 0.05), new CircleTarget(G.X2 - 50, 100, 60, 0.05), new CircleTarget(G.X2, 150, 60, -0.05), ], // 9
 [new CircleTarget(G.X2, 100, 90, 0.05), new SlideXTarget(50, 40, 1), new SlideXTarget(G.SCREEN_WIDTH - 50, 160, -1), ], // 10
 [new Target(G.X2, 100), new CircleTarget(G.X2, 100, 67, -0.05), new CircleTarget(G.X2, 100, 100, +0.05), new SlideXTarget(50, 190, 1), ], // 11
 [new SlideXTarget(50, 40, 1), new SlideXTarget(90, 100, 2), new SlideXTarget(130, 160, 3), new CircleTarget(G.X2, G.Y2 - 21, 90, 0.1), ], // 12
 [new SlideXTarget(50, 40, 1), new SlideXTarget(90, 100, 2), new SlideXTarget(130, 160, 3), new SlideXTarget(G.X2, 70, -4), new SlideXTarget(G.X2, 130, 4), ], // 13
 [new CircleTarget(40, 70, 10, -0.4), new CircleTarget(G.SCREEN_WIDTH - 40, 170, 10, 0.4), new CircleTarget(G.X2, 100, 70, +0.05), new CircleTarget(G.X2, 100, 70, +0.05, ((2 * Math.PI) / 3)), new CircleTarget(G.X2, 100, 70, +0.05, (2 * (2 * Math.PI) / 3)), ], // 14
 [new CircleTarget(G.X2 + 50, 100, 60, -0.05), new CircleTarget(G.X2 - 50, 100, 60, 0.05), new SlideXTarget(50, 40, 1), new SlideXTarget(G.SCREEN_WIDTH - 50, 160, -1), ], // 15
 [new CircleTarget(G.SCREEN_WIDTH - 70, 70, 20, -0.2), new CircleTarget(G.SCREEN_WIDTH - 70, 70, 20, -0.2, Math.PI), new CircleTarget(70, 170, 20, 0.2), new CircleTarget(70, 170, 20, 0.2, Math.PI), new CosTarget(G.SCREEN_WIDTH - 50, 40, 2), new CosTarget(50, 160, -2), ], // 16*
...
function TargetList(targets){
    ...
    this.checkVictory = function(o){
        ...
        if (matches == this.mTargets.length) 
            return true;
        else 
            return false;
...
function NewGameState(){
    ...
    sun.ondblclick = function(){
        ...
        if (GameState._isMove) 
            GameState._isMove = false;
        else 
            GameState._isMove = true;
